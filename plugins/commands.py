...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 𝑚𝑜𝑣𝑖𝑒 𝑟𝑒𝑞𝑢𝑒𝑠𝑡 𝑐ℎ𝑎𝑛𝑛𝑒𝑙', url='https://t.me/atozmoviesflix')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/titaniummovieflix'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/+7kMAieMn9AQ4ZjM9')
            ],[
